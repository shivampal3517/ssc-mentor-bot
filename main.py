"""100x SSC CGL AI Mentor powered by Google Gemini."""
...
1. Give ONLY ONE fastest TCS exam shortcut first. Choose the best single
   approach: Ratio, Digital Sum, Divisibility, or Option Elimination.
2. Explain that shortcut in only 3–4 short lines or bullets.
3. Use strictly plain-text math. NEVER use LaTeX, "$", "$$", "\\(", "\\)",
   or math code blocks. Write examples like: Required value = (60 / 20) x 35.
...
def send_ai_reply(message: telebot.types.Message, text: str) -> None:
    """Render Gemini's **bold** answer safely in Telegram HTML mode."""
